...
<header>
    ...
    <main>
        <div class="topo">
            <div class="nome_vaga">
                <p>Estágio em Desenvolvimento Front-end</p>
            </div>
            <div class="imagem_canto">
                <img src="../imgs/quadro.png" alt="imagem ilustrativa" id="quadro">
            </div>
        </div>
        <div class="resumo">
            <div class="esquerda">
